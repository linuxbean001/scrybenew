...
<template>
  ...
  <div>
    ...
    <div class="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
      ...
      <div class="flex flex-grow flex-col overflow-y-auto border-r border-gray-200 bg-white pt-2">
        <div class="flex flex-shrink-0 items-center px-4">
          <img class="h-24 pl-2 w-auto" src="../assets/images/logo.png" alt="Your Company" />
        </div>
...
const navigation = [
  ...
  { name: 'Library', href: '/library', icon: InboxIcon, current: false },
  { name: 'Chat', href: '/chat', icon: ChatBubbleLeftEllipsisIcon, current: false },
]
